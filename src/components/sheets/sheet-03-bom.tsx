        ...
        <tbody>
          {skills.map((row, i) => (
            ...
            >
              ...
              <th
                scope="row"
                className="block pb-1 text-left font-mono text-[0.7rem] font-semibold uppercase tracking-[0.12em] text-ink sm:table-cell sm:py-3.5 sm:pr-4"
              >
                {row.category}
              </th>
              <td className="block text-[0.85rem] leading-relaxed text-pencil sm:table-cell sm:py-3.5">{row.spec}</td>
            </motion.tr>
          ))}
        </tbody>
      </table>
